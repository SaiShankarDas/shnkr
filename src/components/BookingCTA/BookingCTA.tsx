                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-24 items-start">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-3">
                            <a
                                href="https://wa.me/918249003677?text=Hi%21%20I%27d%20like%20to%20book%20a%20free%20discovery%20call."
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 border border-white/10 text-white/60 text-sm uppercase tracking-wider rounded-full hover:border-accent/40 hover:text-white transition-all duration-300"
                            >
